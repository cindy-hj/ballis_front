    ...
    <div class="common_mt160">
        <div class="container" id="wrap" v-if="state.row.length > 0">
            <div class="top d-flex flex-column align-items-center justify-content-center">
                <div v-show="state.type === 'fast'" class="top_info">
                    <h3>구매가 완료되었습니다.</h3>
                    <p>구매한 상품은 자정전까지 결제한건에 대하여</p>
                    <p>다음날 즉시 출고될 예정입니다.</p>                
                </div>
                <div v-show="state.type === 'normal'" class="top_info">
                    <h3>즉시 구매가 완료되었습니다.</h3>
                    <p>구매한 상품은 전문가의 검수 완료 후,</p>
                    <p>안전하게 배송될 예정입니다.</p>
                </div>
                <div v-show="state.type === 'bid'" class="top_info">
